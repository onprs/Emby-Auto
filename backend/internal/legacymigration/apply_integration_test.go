...
`, profileID, "legacy-migration-test-"+testID); err != nil {
	...
	seedStatements := []struct {
		...
		{query: "INSERT INTO episode_mapping_profiles (id, series_id, name, version, active, decision_source) VALUES ($1, $2, 'legacy-migration', 1, false, 'legacy')", args: []any{existingMappingProfileID, existingSeriesID}},
