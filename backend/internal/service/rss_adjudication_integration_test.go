...
INSERT INTO operations (id, kind, resource_type, resource_id, idempotency_key, status, max_attempts, timeout_seconds, finished_at)
VALUES ($1, 'agent.resolve', 'agent_resolution', $2, $3, 'succeeded', 3, 60, now());
