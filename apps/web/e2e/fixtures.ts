...
export async function stubAuthenticatedApp(page: Page) {
  ...
  await page.route('**/api/v1/dashboard/system-metrics', (route) =>
    json(route, {
      ...
      disks: [
        { device: 'nvme0n1', path: '/', usedBytes: 644245094400, totalBytes: 1073741824000, usedPercent: 60 },
        { device: 'sda', path: '/data/video/video1', usedBytes: 300647710720, totalBytes: 644245094400, usedPercent: 50 },
      ],
      samples: [
